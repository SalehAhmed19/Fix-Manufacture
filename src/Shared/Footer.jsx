...
//     <Fade up>
//       <div className="mt-10">
//         <footer className="footer p-10 bg-[#FFC001] text-base-content">
//           <div>
...
//           </div>
//         </footer>
//         <footer className="footer px-10 py-4 border-t bg-[#FFC001] text-base-content border-[#FF7400]">
...
const Footer = () => {
  ...
  return (
    <Fade up>
      <div className="bg-[#FDBE06] bg-footer w-full bg-footer">
        <Container
          maxWidth="md"
          component="footer"
          sx={{
